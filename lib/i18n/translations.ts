...
export function getTaskDetailsPageTexts(language: AppLanguage) {
  if (language === "en") {
    return {
      ...
      readiness: {
        sectionTitle: "Property readiness",
        sectionHelp: "The readiness status of the property at the time of this task. Reflects active property conditions.",
        statusLabel: "Readiness status",
        statusHelp: "Possible values: ready / borderline / not ready / unknown.",
        openConditionsLabel: "Open conditions",
        openConditionsHelp: "Total active property conditions.",
        blockingLabel: "Blocking",
        blockingHelp: "Conditions that currently block readiness.",
        warningsLabel: "Warnings",
        warningsHelp: "Conditions flagged as warnings.",
        nextCheckIn: "Next check-in",
        snapshotReasoning: "Readiness reasoning",
      },

      conditionsFromTask: {
        sectionTitle: "Conditions created from this task",
        sectionHelp: "Conditions registered on the property as a result of this task.",
      ...
      conditionSnapshot: {
        sectionTitle: "Property conditions",
        sectionHelp: "Active conditions that determine the operational state of the property.",
  ...
  return {
    ...
    readiness: {
      sectionTitle: "Ετοιμότητα ακινήτου",
      sectionHelp: "Η κατάσταση ετοιμότητας του ακινήτου κατά τη διάρκεια αυτής της εργασίας. Αντικατοπτρίζει τις ενεργές συνθήκες ακινήτου.",
      statusLabel: "Κατάσταση ετοιμότητας",
      statusHelp: "Πιθανές τιμές: έτοιμο / οριακό / μη έτοιμο / άγνωστο.",
      openConditionsLabel: "Ενεργές συνθήκες",
      openConditionsHelp: "Σύνολο ενεργών συνθηκών ακινήτου.",
      blockingLabel: "Μπλοκαρισμένες",
      blockingHelp: "Συνθήκες που μπλοκάρουν την ετοιμότητα.",
      warningsLabel: "Προειδοποιήσεις",
      warningsHelp: "Συνθήκες που σημειώθηκαν ως προειδοποιήσεις.",
      nextCheckIn: "Επόμενο check-in",
      snapshotReasoning: "Αιτιολόγηση ετοιμότητας",
    },

    conditionsFromTask: {
      sectionTitle: "Συνθήκες που δημιουργήθηκαν από αυτή την εργασία",
      sectionHelp: "Συνθήκες που καταχωρήθηκαν στο ακίνητο ως αποτέλεσμα αυτής της εργασίας.",
    ...
    conditionSnapshot: {
      sectionTitle: "Συνθήκες ακινήτου",
      sectionHelp: "Ενεργές συνθήκες που καθορίζουν τη λειτουργική κατάσταση του ακινήτου.",
