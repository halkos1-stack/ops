...
export const translations = {
  el: {
    ...
    managementViewHint:
      "Κεντρικές ενέργειες για στοιχεία ακινήτου, λειτουργικό συνεργάτη και τις 3 ενότητες εκτέλεσης.",
    month: "Μήνας",
    week: "Εβδομάδα",
    day: "Ημέρα",
    ...
    partnerTitle: "Προεπιλεγμένος λειτουργικός συνεργάτης",
    ...
    save: "Αποθήκευση",
    cancel: "Κλείσιμο",
    lists: "Ενότητες εκτέλεσης ακινήτου",
    editProperty: "Στοιχεία ακινήτου",
    editPartner: "Συνεργάτης",
    editListsHint:
      "Μετάβαση στις 3 ενότητες εκτέλεσης του ακινήτου: καθαριότητα, αναλώσιμα και βλάβες / ζημιές.",
    editPropertyHint:
      "Ενημέρωση βασικών στοιχείων ακινήτου χωρίς έξοδο από τη σελίδα.",
    editPartnerHint:
      "Ορισμός ή αλλαγή προεπιλεγμένου λειτουργικού συνεργάτη για το ακίνητο.",
    managementTitle: "Κεντρική διαχείριση readiness ακινήτου",
    managementSubtitle:
      "Οι βασικές ενέργειες μένουν συγκεντρωμένες εδώ, ενώ η επιχειρησιακή εικόνα δίνεται στο ημερολόγιο και στις 3 ενότητες εκτέλεσης.",
    hour: "Ώρα",
  ...
  en: {
    ...
    managementViewHint:
      "Core actions for property details, the operational partner and the three execution sections.",
    month: "Month",
    week: "Week",
    day: "Day",
    previous: "Previous",
    ...
    partnerTitle: "Default operational partner",
    taskModalTitle: "Task",
    ...
    save: "Save",
    cancel: "Close",
    lists: "Property execution sections",
    editProperty: "Property details",
    editPartner: "Partner",
    editListsHint: "Open the three property execution sections: cleaning, supplies and issues / damages.",
    editPropertyHint: "Update core property fields without leaving this page.",
    editPartnerHint: "Set or change the default operational partner for this property.",
    managementTitle: "Property readiness management center",
    managementSubtitle:
      "Core actions stay here, while the operational picture is shown in the calendar and across the three execution sections.",
    hour: "Hour",
