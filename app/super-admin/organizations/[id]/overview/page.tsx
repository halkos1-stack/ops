      ...
      <section className="rounded-3xl border border-blue-200 bg-white p-6 shadow-sm">
        <div className="mb-4 flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">
              Εδώ βλέπεις τον κύριο υπεύθυνο του οργανισμού και μεταβαίνεις
              άμεσα στη σελίδα χρηστών για αποστολή ή επαναποστολή πρόσκλησης
              ενεργοποίησης.
            </p>
          </div>
        ...
        {primaryOrgAdmin ? (
                ...
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    <h3 className="text-base font-bold text-slate-900">
                      {primaryOrgAdmin.user.name || "—"}
                    </h3>

                    <span
                      className={`inline-flex rounded-full px-3 py-1 text-[11px] font-semibold ${
                        primaryOrgAdmin.user.isActive && primaryOrgAdmin.isActive
                          ? "bg-emerald-100 text-emerald-700"
                          : "bg-amber-100 text-amber-700"
                      }`}
                    >
                  ...
                  <p className="mt-2 break-all text-sm text-slate-700">
                    {primaryOrgAdmin.user.email}
                  </p>

                  <p className="mt-1 text-xs text-slate-500">
                    Ρόλος: {getMembershipRoleLabel(primaryOrgAdmin.role)}
                  </p>

                  <p className="mt-1 text-xs text-slate-500">
                    Δημιουργία πρόσβασης: {formatDate(primaryOrgAdmin.createdAt)}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:min-w-[360px]">
                  ...
                  <div className="rounded-2xl bg-slate-50 px-4 py-3">
                    ...
                    <p className="mt-1 text-sm font-semibold text-slate-900">
                      {formatDate(primaryOrgAdmin.user.createdAt)}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
            ...
            οργανισμό. Πήγαινε στη σελίδα «Χρήστες οργανισμού» για να ελέγξεις
            τη δημιουργία χρήστη και να συνεχίσεις το onboarding.
          </div>
        )}
      </section>
      ...
      <section className="grid grid-cols-1 gap-6 2xl:grid-cols-2">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-slate-600">
              Γρήγορη εικόνα των τελευταίων προσβάσεων του οργανισμού.
            </p>
          </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span
                        className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${
                          membership.user.isActive && membership.isActive
                            ? "bg-emerald-100 text-emerald-700"
                            : "bg-amber-100 text-amber-700"
                        }`}
                      >
              ...
              {organization.issues.map((issue) => (
                ...
                >
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    Κατάσταση:{" "}
                    {issue.status != null
                      ? getIssueStatusLabel("el", issue.status)
                      : "—"}{" "}
                    • Σοβαρότητα:{" "}
                    {issue.severity != null
                      ? getIssuePriorityLabel("el", issue.severity)
                      : "—"}
                  </p>
                </div>
              ))}
                  ...
                  <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:min-w-[320px]">
                      ...
                      <div className="rounded-2xl bg-slate-50 px-4 py-3">
                        ...
                        <p className="mt-1 text-xs text-slate-500">
                          {latestAssignment?.status != null
                            ? getAssignmentStatusLabel("el", latestAssignment.status)
                            : "—"}
                        </p>
                      </div>
                    </div>
